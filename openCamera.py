...
eye_cascade=cv2.CascadeClassifier("/home/george/PycharmProjects/Embeded image processing system/frontalEyes35x16.xml")

recognizer=cv2.face.LBPHFaceRecognizer_create()
recognizer.read('recognizer/trainingData.yml')

# labels={"person_name": 1}
with open("/home/george/PycharmProjects/Embeded image processing system/labels.pickle", 'rb') as f:
